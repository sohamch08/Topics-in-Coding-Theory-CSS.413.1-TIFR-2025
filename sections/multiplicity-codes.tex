...
\begin{proof} First we will set some parameters. Let $t=\sqrt{s}\approx \frac1{\eps}$. 
...
\If{$\exs!\ f\in S$ such that $f$ agrees with $w$ at $i_1,\dots, i_{t-1}$}{
    \Return{$f$}
}
